...
org_autor_df.to_sql('org_author', con=engine, schema='citation_network', if_exists='append', index=False, chunksize=100)
...
df_fos.to_sql('fos', con=engine, schema='citation_network', if_exists='append', index=False, chunksize=100)
...
df_text_fos.to_sql('text_fos', con=engine, schema='citation_network', if_exists='append', index=False, chunksize=100)
...
df_keywords.to_sql('keywords', con=engine, schema='citation_network', if_exists='append', index=False, chunksize=100)
...
df_text_keywords.to_sql('text_keywords', con=engine, schema='citation_network', if_exists='append', index=False, chunksize=100)
...
df_citation.to_sql('citation', con=engine, schema='citation_network', if_exists='append', index=False, chunksize=100)
...
df_tags.to_sql('tags', con=engine, schema='citation_network', if_exists='append', index=False, chunksize=100)
df_tags_text = pd.DataFrame(tmp_l, columns=['tag_text_id', 'tag_id', 'text_id'])
df_tags_text.to_sql('text_tags', con=engine, schema='citation_network', if_exists='append', index=False, chunksize=100)
